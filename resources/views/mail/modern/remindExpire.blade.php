...
@section('content')
    ...
    <div style="display:inline-block; margin:0 0 22px; padding:12px 16px; border-radius:16px; background:#fff7ed; border:1px solid #fed7aa; color:#b54708; font-size:15px; line-height:1.6; font-weight:700;">你的服务将在 24 小时内到期。</div>
    <div style="font-size:15px; line-height:1.9; color:#344054; background:#f9fafb; border:1px solid #e4e7ec; border-radius:18px; padding:18px 20px;">为了不造成使用上的影响，请尽快续费。如果你已续费，请忽略此邮件。</div>
