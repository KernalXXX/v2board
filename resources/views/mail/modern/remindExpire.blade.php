...
@section('content')
    ...
    <div style="display:inline-block; margin:0 0 22px; padding:12px 16px; border-radius:16px; background:#fff7ed; border:1px solid #fed7aa; color:#b54708; font-size:15px; line-height:1.6; font-weight:700;">您的服务将在 24 小时内到期。</div>
